...
A summary of the f1-scores and accuracies produced by the different Logistic Regression Model variations can be observed in figure X. 
...
Additionally, in figure Z, one may observe how well each model predicted the genre of a movie for each class. 
