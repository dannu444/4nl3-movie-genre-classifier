...
\begin{figure*}[t]
  \includegraphics[width=\linewidth]{Lily/Images/comparison_results.png} \hfill
  \caption {Comparison of BERT-base-uncased transformer model to the baseline models.}
\end{figure*}
